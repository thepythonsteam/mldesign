...
#         self.end_page = end_page
    ...
    @staticmethod
    def csv_writer(data):
        with open('export/ads_moscow_5_10_2022.csv', 'a', encoding='utf-8', errors='replace') as f:
            fieldnames = [
                'id',
                'date',
                'region',
    ...
    def parse_page(self, html: str):
        ...
        try:
            ...
            current_page = None
        t = soup.findAll('script', {'type': 'text/javascript'})[3].decode_contents().strip().split("window._cianConfig['legacy-commercial-serp-frontend'] = ")[1]
        t = t[1:-2]
